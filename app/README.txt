#### Requirements
Node.js and npm are required. To install both components run the install.sh script. The downloads are compatible with OS X and Linux (Debian) distrubutions only.
